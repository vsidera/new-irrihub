...
const SmartFarm = () => {
  ...
  const [pumps, setPumps] = useState( [
    ...
    { id: 3, name: "Pump 3", mode: "manual", status: "ON" },
    { id: 4, name: "Pump 4", mode: "manual", status: "OFF" },
    { id: 5, name: "Pump 4", mode: "auto", status: "ON" },
    { id: 6, name: "Pump 6", mode: "manual", status: "ON" },
  ]);

  const [valves, setValves] = useState( [
    { id: 1, name: "Valve 1", mode: "manual", status: "OFF" },
    { id: 2, name: "Valve 2", mode: "auto", status: "ON" },
    { id: 3, name: "Valve 3", mode: "manual", status: "ON" },
    { id: 4, name: "Valve 4", mode: "manual", status: "ON" },
    { id: 5, name: "Valve 5", mode: "auto", status: "ON" },
    { id: 6, name: "Valve 6", mode: "manual", status: "OFF" },
    { id: 7, name: "Valve 7", mode: "manual", status: "ON" },
    { id: 8, name: "Valve 8", mode: "auto", status: "OFF" },
    { id: 9, name: "Valve 9", mode: "manual", status: "OFF" },
  ]);
